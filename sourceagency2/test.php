<?php
/*
 * $Horde: horde/test.php,v 1.1.2.19 2000/11/06 21:16:32 bjn Exp $
 *
...
<ul>
    ...
    <?php if ($phplib) { ?>
        ...
        if ($sess): ?>
            ...
            <li><a href="test.php?mode=phplib-sourceagency">Click here to test PHPLIB for SourceAgency</a> (If this link results in "Document Contains No Data" or "Fatal error...", then you probably have not defined the SourceAgency_Session class in the PHPLIB local.inc file).</li>
        <?php endif; ?>
    <?php } ?>
</ul>
