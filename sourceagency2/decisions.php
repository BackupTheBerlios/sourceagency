...
#
# $Id: decisions.php,v 1.1 2003/11/21 12:55:58 helix Exp $
#
######################################################################  
...
if (check_permission($proid, $page)) {
	...
	if (!strcmp($vote, 'vote')) {
            ...
            case '4':
                ...
                break;
            default:
	        lib_die('Error in decisions.php: No decision can be '
                        .'put into database');
            }
  	...
  	// If the sponsor has already voted, then we look for his vote
        ...
        case '5':  
            ...
            htmlp_link('step5_sponsor.php',array('proid' => $proid),
        ...
        case '6':  
            ...
            htmlp_link('step6_edit.php',array('proid' => $proid),
                       $t->translate('Decision on step 6')
                       .' ('.$g_step_text[6].')'); 
            break;
        default:
           lib_die('Error in decisions.php: given project status '
                   .'is not possible');
	}
    }
