...
if (check_proid($proid)) {
  ...
  print "A sponsor may require help to submit a project in a propper way. If he wishes, he can ask SourceAgency registered developers to assist him on this topic.\n";

  if (consultants_wanted($proid)) {

	print "<p align=right>[ <b>".html_link("step1_edit.php3",array("proid" => $proid),"Propose yourself as consultant")."</b> ]\n";
